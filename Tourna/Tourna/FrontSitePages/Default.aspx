...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%">
        ...
        <tr>
            <td style="text-align: center" class="GrayTextNormal">
                For online demo click <a href="" class="AzureText">here</a>
            </td>
        </tr>
    </table>
    <table style="width: 100%;padding:0px" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td style="background-color: #f7f7f6; height: 15px" colspan="5">
            </td>
        </tr>
        <tr>
            <td style="width: 32%">
            ...
            <td style="background-color: #f7f7f6; width: 5px">
            </td>
            <td style="width: 32%">
                <table style="width: 100%">
                    <tr>
        ...
        <tr>
            <td class="AzureText" style="padding-left:5px">
                Aharon Company
            </td>
            <td>
            </td>
