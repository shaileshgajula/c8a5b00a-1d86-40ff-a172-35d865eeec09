<%@ Page Title="" Language="C#" MasterPageFile="~/OrganisationSite/OrgSite.Master"
    AutoEventWireup="true" CodeBehind="Schedules.aspx.cs" Inherits="StrongerOrg.OrganisationSite.Schedules" Theme="OrganisationSite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadScheduler ID="RadScheduler1" runat="server" DataEndField="End" 
        ...
        ValidationGroup="RadScheduler1" SelectedView="MonthView"
